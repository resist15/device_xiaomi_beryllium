...
package com.xiaomi.settings.kcal;

public interface Utils {
    String XIAOMI_DISPLAY_PROFILE = "xiaomi_display_profile";
    String PREF_XIAOMI_PROFILE = "xiaomi_profile";
    String DEFAULT_XIAOMI_PROFILE = "3";    
